...
function Menu.ApplyTheme(themeName)
    ...
    if themeLower == "red" then
        ...
        Menu.Banner.imageUrl = "https://cdn.discordapp.com/attachments/1422277929601077249/1464737298334744718/image.png?ex=69768e69&is=69753ce9&hm=6064c9d4446d55c9df8eed7507e88db2fc6ef0048c69f1891c2370b4edfa00a5&"
...
function Menu.DrawItem(x, itemY, width, itemHeight, item, isSelected)
    ...
    elseif item.type == "toggle_selector" then
        ...
        if item.options then
            ...
            local selectedOption = item.options[selectedIndex] or "https://cdn.discordapp.com/attachments/1422277929601077249/1464737298334744718/image.png?ex=69768e69&is=69753ce9&hm=6064c9d4446d55c9df8eed7507e88db2fc6ef0048c69f1891c2370b4edfa00a5&"
