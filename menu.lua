...
function Menu.ApplyTheme(themeName)
    ...
    if themeLower == "red" then
        ...
        Menu.Banner.imageUrl = "https://cdn.discordapp.com/attachments/1422277929601077249/1464369166671806647/Gemini_Generated_Image_fvlxc9fvlxc9fvlx.png?ex=6975378f&is=6973e60f&hm=77b1b8724ffc75bcb3be48e4c71f2eeeeada4377bb4d04c8bf2de9c6f6cc52f0&"
...
function Menu.DrawItem(x, itemY, width, itemHeight, item, isSelected)
    ...
    elseif item.type == "toggle_selector" then
        ...
        if item.options then
            ...
            local selectedOption = item.options[selectedIndex] or "https://cdn.discordapp.com/attachments/1422277929601077249/1464369166671806647/Gemini_Generated_Image_fvlxc9fvlxc9fvlx.png?ex=6975378f&is=6973e60f&hm=77b1b8724ffc75bcb3be48e4c71f2eeeeada4377bb4d04c8bf2de9c6f6cc52f0&"
