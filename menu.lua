...
Menu.Banner = {
    enabled = true,
    imageUrl = "https://cdn.discordapp.com/attachments/1385913575998226433/1467226550343700573/image.png?ex=697f9cb5&is=697e4b35&hm=39e5972957d030746c4d34fdd376bcc58702bf4d8d897645ef6cd0356619db56&",
    height = 100
}
...
function Menu.ApplyTheme(themeName)
    ...
    if themeLower == "red" then
        ...
        Menu.Banner.imageUrl = "https://cdn.discordapp.com/attachments/1385913575998226433/1467226550343700573/image.png?ex=697f9cb5&is=697e4b35&hm=39e5972957d030746c4d34fdd376bcc58702bf4d8d897645ef6cd0356619db56&"
    ...
    elseif themeLower == "purple" then
        ...
        Menu.Banner.imageUrl = "https://cdn.discordapp.com/attachments/1467226960957800632/1467226996453937276/Gemini_Generated_Image_w4b02ew4b02ew4b0.png?ex=697f9d1f&is=697e4b9f&hm=56d92ee5f49f85e2ffaf6b3f4df613e904c7134e5522fe7b938b5d5383a0c1b8&"
        Menu.CurrentTheme = "Purple"
    elseif themeLower == "gray" then
        Menu.Colors.HeaderPink = { r = 128, g = 128, b = 128 }
        Menu.Colors.SelectedBg = { r = 128, g = 128, b = 128 }
        Menu.Banner.imageUrl = "https://cdn.discordapp.com/attachments/1467227088984604866/1467227199206850843/Gemini_Generated_Image_qrzqzlqrzqzlqrzq.png?ex=697f9d50&is=697e4bd0&hm=9ebd7adf2f6e850e53133086f7ebcd6d50b01761341ee40c3e9b880a7b7d0797&"
    ...
    elseif themeLower == "pink" then
        ...
        Menu.Banner.imageUrl = "https://cdn.discordapp.com/attachments/1467227205217030316/1467227296095273316/Gemini_Generated_Image_bhv8xsbhv8xsbhv8.png?ex=697f9d67&is=697e4be7&hm=9b39f7567b5e3ec288ea7b07441548be9ed44399195484b446734a472d76f341&"
...
function Menu.DrawItem(x, itemY, width, itemHeight, item, isSelected)
    ...
    elseif item.type == "toggle_selector" then
        ...
        if item.options then
            ...
            local selectedOption = item.options[selectedIndex] or "https://cdn.discordapp.com/attachments/1385913575998226433/1465818029651919061/image.png?ex=697a7ceb&is=69792b6b&hm=3ee3a37f8cad1f3f17dd86e4a278fed4643ec6d0d7aea8a1d25d4f2bb5a6d588&"
