...
Menu.Banner = {
    enabled = true,
    imageUrl = "https://hizliresim.com/k24z7xy",
    height = 100
}
...
function Menu.ApplyTheme(themeName)
    ...
    if themeLower == "red" then
        ...
        Menu.Banner.imageUrl = "https://hizliresim.com/k24z7xy"
    ...
    elseif themeLower == "pink" then
        ...
        Menu.Banner.imageUrl = "https://hizliresim.com/1kypzvu"
