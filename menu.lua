...
Menu.Banner = {
    enabled = true,
    imageUrl = "https://resmim.net/cdn/2026/02/24/wpQC3W.jpg",
    height = 100
}
...
function Menu.ApplyTheme(themeName)
    ...
    if themeLower == "red" then
        ...
        Menu.Banner.imageUrl = "https://resmim.net/cdn/2026/02/24/wpQC3W.jpg"
    ...
    elseif themeLower == "purple" then
        ...
        Menu.Banner.imageUrl = "https://resmim.net/cdn/2026/02/24/wpQl1Q.png"
        Menu.CurrentTheme = "Purple"
    elseif themeLower == "gray" then
        Menu.Colors.HeaderPink = { r = 128, g = 128, b = 128 }
        Menu.Colors.SelectedBg = { r = 128, g = 128, b = 128 }
        Menu.Banner.imageUrl = "https://resmim.net/cdn/2026/02/24/wpQ3P3.png"
    ...
    elseif themeLower == "pink" then
        ...
        Menu.Banner.imageUrl = "https://resmim.net/cdn/2026/02/24/wpQKuH.png"
...
function Menu.DrawItem(x, itemY, width, itemHeight, item, isSelected)
    ...
    elseif item.type == "toggle_selector" then
        ...
        if item.options then
            ...
            local selectedOption = item.options[selectedIndex] or "https://resmim.net/cdn/2026/02/24/wpQC3W.jpg"
